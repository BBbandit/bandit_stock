...
def save_nph_stock_top_data(date, before=True):
    ...
    try:
        ...
        print(f"basic_data_other_daily_job.save_stock_top_data处理异常：{e}")
    stock_spot_buy(date)
...
def save_stock_blocktrade_data(date):
    try:
        ...
        print(f"basic_data_other_daily_job.save_stock_blocktrade_data处理异常：{e}")
...
def save_nph_stock_fund_flow_data(date, before=True):
    ...
    try:
        ...
        print(f"basic_data_other_daily_job.save_nph_stock_fund_flow_data处理异常：{e}")
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=len(times)) as executor:
            ...
            for future in concurrent.futures.as_completed(future_to_data):
                ...
                try:
                    ...
                    print(f"basic_data_other_daily_job.run_check_stock_fund_flow处理异常：代码{e}")
    except Exception as e:
        print(f"basic_data_other_daily_job.run_check_stock_fund_flow处理异常：{e}")
    if not data:
        return None
    else:
        return data
...
def stock_sector_fund_flow_data(date, index_sector):
    try:
        ...
        print(f"basic_data_other_daily_job.stock_sector_fund_flow_data处理异常：{e}")
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=len(times)) as executor:
            ...
            for future in concurrent.futures.as_completed(future_to_data):
                ...
                try:
                    ...
                    print(f"basic_data_other_daily_job.run_check_stock_sector_fund_flow处理异常：代码{e}")
    except Exception as e:
        print(f"basic_data_other_daily_job.run_check_stock_sector_fund_flow处理异常：{e}")
    if not data:
        return None
    else:
        return data
...
def save_nph_stock_bonus(date, before=True):
    ...
    try:
        ...
        print(f"basic_data_other_daily_job.save_nph_stock_bonus处理异常：{e}")
...
def stock_spot_buy(date):
    try:
        ...
        print(f"basic_data_other_daily_job.stock_spot_buy处理异常：{e}")
